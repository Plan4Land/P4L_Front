        ...
        <SignupContainer>
          ...
          <Terms>
            ...
            <div className="terms-content">
              ...
              <p>당사는 서비스를 제공하기 위해 아래와 같은 개인정보를 수집합니다:</p>
              <ul>
                <li>이메일 주소: 서비스 가입 및 이메일 인증을 위해 필수로 수집합니다.</li>
                <li>카카오 고유 ID: 카카오 소셜 로그인 사용자의 인증 및 계정 관리를 위해 수집됩니다.</li>
              </ul>

              <h4>2. 개인정보의 수집 및 이용 목적</h4>
              <p>이메일 주소는 유저 인증, 계정 관리, 서비스 이용에 관한 중요한 정보를 전달하기 위해 사용됩니다.</p>
              <p>카카오 고유 ID는 카카오 소셜 로그인 사용자 인증을 위한 계정 식별 용도로 사용됩니다.</p>

              <h4>3. 개인정보의 보유 및 이용 기간</h4>
              <p>이메일 주소와 카카오 고유 ID는 서비스 이용 기간 동안 보유됩니다.</p>
              <p>법적 요구사항에 따라 일정 기간 보유해야 하는 경우 해당 기간 동안 보관됩니다.</p>

              <h4>4. 개인정보 수집 및 이용 동의를 거부할 권리</h4>
              <p>이용자는 개인정보의 수집 및 이용에 대한 동의를 거부할 권리가 있습니다.</p>
              <p>회원가입 시 수집되는 최소한의 개인정보, 즉 필수 항목에 대한 수집 및 이용 동의를 거부할 경우, 회원가입이 어려울 수 있습니다.</p>

              <h4>5. 개인정보의 제3자 제공</h4>
              <p>당사는 이용자의 이메일 주소와 카카오 고유 ID를 제3자에게 제공하지 않습니다. (단, 법적 의무가 있을 경우 제공할 수 있습니다.)</p>

              <h4>6. 개인정보 보호</h4>
              <p>개인정보 보호를 위해 불법적인 접근을 방지하는 보안 시스템을 적용합니다.</p>

              <h4>7. 이용자의 권리</h4>
              <p>이용자는 언제든지 이메일 주소를 조회할 수 있습니다.</p>
              <p>이메일 주소 수정은 '내 정보 수정' 메뉴에서 가능하며, 카카오 고유 ID와 관련된 문의는 고객센터로 연락해주시기 바랍니다.</p>

              <h4>8. 개인정보 처리방침의 변경</h4>
              <p>개인정보 처리방침을 변경할 경우, 변경 사항은 웹사이트에 공지하거나 개별 통지를 통해 안내됩니다.</p>
